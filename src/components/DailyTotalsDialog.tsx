...
interface DailyTotalsData {
  payments: { cash: number; card: number; voucher: number; total: number };
  tips: { cash: number; card: number; voucher: number; total: number; by_therapist: TherapistTips[] };
  combined: { cash: number; card: number };
}
            ...
            <Box>
              ...
              <Table size="small">
                <TableBody>
                  ...
                  <TableRow>
                    <TableCell sx={{ color: "text.secondary" }}>{t("voucher")}</TableCell>
                    <TableCell align="right"><strong>{formatMoney(data.payments.voucher)}</strong></TableCell>
                  </TableRow>
