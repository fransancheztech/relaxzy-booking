import { BOOKING_DEFAULT_DURATIONS, BOOKING_DEFAULT_PRICES, BOOKING_DEFAULT_SERVICES } from "@/constants";
...
const FormFields = () => {
    ...
    return (
        <Grid container sx={{ paddingTop: '1rem' }} spacing={{ xs: 1, xl: 2 }}>
            ...
            <Grid size={6}>
                <Controller name="client_surname" control={control} render={({ field }) => (
                    <TextField
                        {...field}
                        label='Surname(s)'
                ...
                <Controller name="client_phone" control={control} render={({ field }) => (
                    <TextField
                        {...field}
                        label='Phone'
